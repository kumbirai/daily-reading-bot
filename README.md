...
3. Let's convert that into a [Python function with the request library](https://github.com/kumbirai/daily-reading-bot/blob/main/start/whatsapp_quickstart.py).
...
- **Background Tasks**:
  ...
  - Scraping jobs run daily at 03:00 AM and every 3 hours
